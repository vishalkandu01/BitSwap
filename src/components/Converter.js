...
function Converter() {
    ...
    return (
        <div className='container'>
            <Card title={<h1> <RiCoinsLine/> Crypto Converter</h1>}>
            </Card>

            <Form size="large">
                <Form.Item>
                    <Input className='crypto-card' placeholder='Enter value' onChange={(event)=>{setInputValue(event.target.value)}}/>
                </Form.Item>
            </Form>
            <div className='select-box'>
                <Select style={{ width: '200px', border: '2px solid rgb(182, 181, 181)', borderRadius: '7px'}} defaultValue={defaultFirstSelectValue} options={cryptoList} onChange={(value) => setFirstSelect(value)}/>
                <Select style={{ width: '200px', border: '2px solid rgb(182, 181, 181)', borderRadius: '7px'}} defaultValue={defaultSecondSelectValue} options={cryptoList} onChange={(value) => setSecondSelect(value)}/>
            </div>
            {/* <p>2 Bitcoin = 12 Etherium</p> */}
